...
def firebase_escape(string):
    ...
    return base64.urlsafe_b64encode(bytes(string, "utf8")).decode("utf8")

def firebase_unescape(string):
    return base64.urlsafe_b64decode(bytes(string, "utf8")).decode("utf8")

def escape_string_args(func, *args, **kwargs):
